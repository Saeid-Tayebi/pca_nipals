...
class MyPca:
    def __init__(self):
        ...
        MyPca.tsquared =None
        MyPca.T2_lim=None
        MyPca.ellipse_radius =None
        MyPca.SPE_x =None
        MyPca.SPE_lim_x =None
        MyPca.Rsquared =None
        MyPca.covered_var =None
        MyPca.x_scaling =None
        MyPca.Xtrain_normal =None
        MyPca.Xtrain_scaled =None
        MyPca.alpha =None
        MyPca.Num_com =None

    def train(self,X, Num_com, alpha=0.95, to_be_scaled=1):
